...
3. Prototype the production time-stretch/key-lock path behind a bounded core-friendly interface. Keep ordinary playback independent, pin and license-review any upstream before integration, and require deterministic ratio/pitch/latency/reset/seek tests plus realtime-allocation evidence before replacing the fallback pitch-changing rate converter.
