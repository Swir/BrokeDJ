...
- Discontinuity-identity hardening PR #17 is under exact-final-head qualification and must not merge until the same Linux + Windows development gate is green on its final head.
