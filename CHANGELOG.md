...
- The native JUCE app still does not instantiate/manage the opt-in key-lock owner or expose a key-lock control. App/device/load/seek/loop/rate/pitch lifecycle serialization, reviewed listening, physical device latency and hardware deadline/underrun qualification remain open.
